...
public class sixtyeight extends AppCompatActivity {

    private ExoPlayer player;
    private PlayerView playerView;
    private final String videoUrl = "https://aaditya-red-mountain.s3.ap-south-1.amazonaws.com/yog_68.mp4";

    @OptIn(markerClass = UnstableApi.class)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sixtyeight);
